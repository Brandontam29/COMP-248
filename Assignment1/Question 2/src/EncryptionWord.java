...
public class Encryption {
	...
	public static void main(String[] args) {
		...
		// Displays the length of each word
		...
		// Concatenates bits and parts of both words to create the combined word
		...
		// Concatenates both words differently to create the encrypted word
